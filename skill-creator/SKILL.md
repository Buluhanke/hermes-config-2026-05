...
- `references/skills-reorganization-workflow.md` — skill 库重组标准工作流（depth=1 提升、重复删除、supporting content 恢复）。**重要**：所有 ~/.hermes/skills/ 的写操作必须用 terminal，不能用 execute_code。
