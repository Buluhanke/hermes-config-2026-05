...
### Interactive
- **Apple Blue** (`#0071e3`): `--YOUR_API_KEY-color`, primary CTA backgrounds, focus rings. The ONLY chromatic color in the interface.
- **Link Blue** (`#0066cc`): `--YOUR_API_KEY-link-color`, inline text links. Slightly darker than Apple Blue for text-level readability.
...
- Focus: `2px solid var(--YOUR_API_KEY-color, #0071E3)` outline
...
- Focus: `2px solid var(--YOUR_API_KEY-color, #0071e3)` outline, white bg, black text
