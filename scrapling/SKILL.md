...
description: Web scraping with Scrapling - HTTP fetching, stealth browser automation,
  Cloudflare bypass, spider crawling, and Scrapy integration via CLI and Python.
version: 1.1.0
author: FEUAZUR
license: MIT
platforms:
...
prerequisites:
  ...
  - scrapling
  - python
  note: 'Scrapling is actively maintained (last commit Jul 2026). Do NOT assume it
    is superseded by Crawl4AI — they serve different niches: Scrapling = adaptive
    fetch + spider + Scrapy bridge; Crawl4AI = LLM-oriented Markdown extraction.'
triggers:
- Use when scrapling
