---
name: auto-1783967305-error-patterns
...
**生成时间**: 2026-07-14 02:28
**扫描窗口**: 最近 24h
**发现模式**: 4 种

## 🟡 TimeoutError (出现 1471 次, 严重度 2)

**文件**: active_learner.log, agent.log, ai_collector.log, errors.log, gateway.error.log
